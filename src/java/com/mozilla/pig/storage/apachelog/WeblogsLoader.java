...
package com.mozilla.pig.storage.apachelog;

import java.util.regex.*;

import com.mozilla.pig.storage.RegExLoader;

/**
 * WeblogsLoader is inspired by CombinedLogLoader/RegexLoader in piggybank.
 * Example Line: 
 * 192.168.1.21 addons.mozilla.org - [16/Jan/2011:05:00:48 -0800] "GET /foo/bar/baz/ HTTP/1.1" 200 4840 "-" "Mozilla/5.0 (Windows; U; Windows NT 5.1; ko; rv:1.9.2.3) Gecko/20100401 Firefox/3.6.13" "-"
 */

...
/**
 * RegExLoader is an abstract class used to parse logs based on a regular
 * expression.
 * 
 * There is a single abstract method, getPattern which needs to return a
 * Pattern. Each group will be returned as a different DataAtom.
 * 
 * Look to org.apache.pig.piggybank.storage.apachelog.CommonLogLoader for
 * example usage.
 * 
 * 2011-02-03 xstevens: I changed the looping structure in getNext() which also
 * fixes an infinite loop that was present in piggybank 0.7.
 */
